...
# install your project dependencies system-wide
# (if you use a requirements.txt file instead of pyproject.toml, change the line below to: RUN uv pip install --system -r requirements.txt)
